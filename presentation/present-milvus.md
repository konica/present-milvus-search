...
--- 
# Failed questions between two searches
...
- Tool call 1
![alt text](assets/azure-ai-search-prompt-tool-call-1.png)
- Tool call 2
![alt text](assets/azure-ai-search-prompt-tool-call-2.png)
- Tool call 3
![alt text](assets/azure-ai-search-prompt-tool-call-3.png)

---
# # Claude Code with A12 RAG MCP in Azure (2)
- Answer
![alt text](assets/azure-ai-search-prompt-answer.png)

---

# Claude Code with A12 RAG MCP on premise
- Tool call 1
![alt text](assets/milvus-prompt-tool-call-1.png)
- Tool call 2
![alt text](assets/milvus-prompt-tool-call-2.png)

--- 
# Claude Code with A12 RAG MCP on premise (2)
- Answer
![alt text](assets/milvus-prompt-answer.png)
